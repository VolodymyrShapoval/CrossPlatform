...
You can read a quickstart for this sample [here](https://auth0.com/docs/quickstart/Lab7.WebApp/aspnet-core).
...
{
    services.AddAuth0Lab7.WebAppAuthentication(options => {
